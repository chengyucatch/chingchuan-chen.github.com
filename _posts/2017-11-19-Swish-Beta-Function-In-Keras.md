---
layout: post
title: "Swish Beta Function In Keras"
---

Google Brain had published a paper: "Swish : A Self-Gated Activation Function" ([Arxiv link](https://arxiv.org/abs/1710.05941)).

In this blogger, I use Keras API of customizing layer to fulfill the Swish Beta function mentioned in paper.

Here is the source code: [GitHub](https://github.com/ChingChuan-Chen/keras_swish_beta).
